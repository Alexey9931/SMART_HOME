...
void Print_Page_Clock_Settings()
{
	...
	switch (up_down_count%8)
	{
		case 0:	
			...
			ILI9486_DrawRect(47,97,70,54,WHITE);
			ILI9486_DrawRect(48,98,68,52,WHITE);
		
			ILI9486_DrawRect(167,97,70,54,BLACK);
			ILI9486_DrawRect(168,98,68,52,BLACK);
		
			ILI9486_DrawRect(312,97,70,54,BLACK);
			ILI9486_DrawRect(313,98,68,52,BLACK);
		
			ILI9486_DrawRect(97,167,70,54,BLACK);
			ILI9486_DrawRect(98,168,68,52,BLACK);
		
			ILI9486_DrawRect(202,167,70,54,BLACK);
			ILI9486_DrawRect(203,168,68,52,BLACK);
		
			ILI9486_DrawRect(312,167,70,54,BLACK);
			ILI9486_DrawRect(313,168,68,52,BLACK);
		...
		case 1: 
			...
			ILI9486_DrawRect(47,97,70,54,BLACK);
			ILI9486_DrawRect(48,98,68,52,BLACK);
		
			ILI9486_DrawRect(167,97,70,54,WHITE);
			ILI9486_DrawRect(168,98,68,52,WHITE);
		...
		case 2: 
			...
			ILI9486_DrawRect(312,97,70,54,WHITE);
			ILI9486_DrawRect(313,98,68,52,WHITE);
		...
		case 3: 
			...
			ILI9486_DrawRect(97,167,70,54,WHITE);
			ILI9486_DrawRect(98,168,68,52,WHITE);
		...
		case 4: 
			...
			ILI9486_DrawRect(202,167,70,54,WHITE);
			ILI9486_DrawRect(203,168,68,52,WHITE);
		...
		case 5: 
			...
			ILI9486_DrawRect(312,167,70,54,WHITE);
			ILI9486_DrawRect(313,168,68,52,WHITE);
...
void Print_Page_About()
{
	...
	ILI9486_Print_String32x32("Время запуска:",TFT_STRING_MODE_BACKGROUND);
...
void Print_Gas_Boiler_Page()
{
	...
	switch (up_down_count%4)
	{
		case 0:
			...
			ILI9486_DrawRect(303,138,175,37,BLACK);
			ILI9486_DrawRect(304,139,173,35,BLACK);
			ILI9486_DrawRect(37,273,414,42,BLACK);
			ILI9486_DrawRect(38,274,412,40,BLACK);
			break;
		case 1:
		...
		case 2:
			...
			ILI9486_DrawRect(297,101,130,37,BLACK);
			ILI9486_DrawRect(298,102,128,35,BLACK);
			ILI9486_DrawRect(303,138,175,37,WHITE);
			ILI9486_DrawRect(304,139,173,35,WHITE);
			ILI9486_DrawRect(37,273,414,42,BLACK);
			ILI9486_DrawRect(38,274,412,40,BLACK);
			break;
		case 3:
