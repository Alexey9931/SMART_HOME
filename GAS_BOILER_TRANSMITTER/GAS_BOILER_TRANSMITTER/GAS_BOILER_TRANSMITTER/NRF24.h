...
#define LOW_CSN PORTB &= ~(1 << SS);// Установка низкого уровня на линии CSN
#define HIGH_CSN PORTB |= (1 << SS);// Установка высокого уровня на линии CSN
//-------------------------------------------------------------
//прототипы функций
void NRF24_ini(void);
